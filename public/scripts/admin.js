  ...
  slicedUsers.forEach((u, i) => {
    html += `
        <tr>
            ...
            <td class="px-6 py-4">${u.no_hp != null ? u.no_hp : "tidak diisi"
      }</td>
            <td class="px-6 py-4">${u.pekerjaan != null ? u.pekerjaan : "tidak diisi"
      }</td>
            <td class="px-6 py-4 text-center">${u.tanggal_terakhir_kali}</td>
            <td class="px-6 py-4 text-center">
                <div class="flex items-center justify-center gap-2">
                    <button onclick="openUserModal('edit',${u.id
                    ...
                    <button onclick="confirmDelete('user', ${u.id}, '${u.responden
  ...
  slicedQuestions.forEach((q, i) => {
    ...
    html += `
        <tr class="hover:bg-gray-50 transition">
            <td class="px-6 py-4 text-sm text-gray-700 font-medium">${start + i + 1
      }</td>
            ...
            <div class="bg-white rounded-xl shadow-md p-4">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex items-start gap-3 flex-1">
                        ...
                        <p class="text-sm text-gray-800 font-medium leading-relaxed">${q.pertanyaan
      }</p>
                    </div>
                </div>
    ...
    rows += `
        <tr class="hover:bg-gray-50 transition">
            ...
            <td class="px-4 py-3 text-center ">
                <button onclick="viewDetailRespondent(${r.id
            ...
            <div class="p-4 hover:bg-gray-50 transition">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex items-center gap-3 flex-1">
                        <div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                            <span class="text-sm font-bold text-green-700">${start + i + 1
      }</span>
                        </div>
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-800 text-sm">${r.responden
      }</h4>
                ...
                <div class="grid grid-cols-3 gap-2 mb-3 text-xs">
                    <div class="bg-gray-50 rounded p-2">
                        ...
                        <span class="font-semibold text-gray-800">${r.umur
      } th</span>
                    </div>
                    <div class="bg-gray-50 rounded p-2">
                        <span class="text-gray-500 block">JK</span>
                        <span class="font-semibold text-gray-800">${r.kelamin
      }</span>
                    </div>
                    <div class="bg-gray-50 rounded p-2">
                        <span class="text-gray-500 block">Pendidikan</span>
                        <span class="font-semibold text-gray-800">${r.lulusan
      }</span>
                    </div>
                </div>
                <button onclick="viewDetailRespondent(${r.id
  ...
  chartResults.forEach((c, i) => {
    row += `
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-6">
                <h4 class="font-semibold text-gray-800 mb-4">${i + 1}. ${c.question
      }</h4>
