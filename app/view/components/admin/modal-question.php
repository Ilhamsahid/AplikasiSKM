    ...
    <form class="p-6 space-y-6" id="formQuestion" method="post">
      <div class="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-green-500 transition">
        ...
        <textarea
          ...
          id="pertanyaanSurvei"
          name="pertanyaan" required></textarea>
      </div>
      ...
      <div class="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-green-500 transition">
        ...
        <div class="space-y-4">
          <!-- opsi id -->
          <input type="hidden" name="opsiIdA" id="opsiIdA"></input>
          <input type="hidden" name="opsiIdB" id="opsiIdB"></input>
          <input type="hidden" name="opsiIdC" id="opsiIdC"></input>
          <input type="hidden" name="opsiIdD" id="opsiIdD"></input>
          <!-- Answer A -->
          <div class="flex items-center gap-3">
            ...
            <input
              ...
              placeholder="Contoh: Tidak Mudah" required>
          ...
          <div class="flex items-center gap-3">
            ...
            <input
              ...
              name="jawabanB"
              class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-500/30 outline-none"
              placeholder="Contoh: Kurang Mudah" required>
            <div class="text-xs text-gray-500 flex-shrink-0">
              2 point
            </div>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <input
              ...
              name="jawabanC"
              class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-500/30 outline-none"
              placeholder="Contoh: Mudah" required>
            <div class="text-xs text-gray-500 flex-shrink-0">
              3 point
            </div>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <input
              ...
              name="jawabanD"
              class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-500/30 outline-none"
              placeholder="Contoh: Sangat Mudah" required>
            <div class="text-xs text-gray-500 flex-shrink-0">
              4 point
            </div>
          </div>
